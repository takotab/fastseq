...
__all__ = ['CreateTSItems', 'TSDataLoader', 'concat_ts_list', 'make_test', 'make_test_pct', 'TSDataLoaders']
...
class CreateTSItems():
    def __init__(self, horizon=None, lookback=72, step=1):
        horizon = ifnone(horizon,int(lookback/4))
        store_attr(self,'horizon,lookback,step')
