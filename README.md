...
```
    ...
    <ipython-input-14-3b16d4e0e2c3> in <module>
          1 from fastai2.interpret import *
    ----> 2 from fastseq.interpret import *
    

    ~/dev/fastseq/fastseq/interpret.py in <module>
          7 from .data.external import *
          8 from fastai2.basics import *
    ----> 9 from .models.nbeats import *
         10 
         11 # Cell
...
```
    ...
    <ipython-input-15-ba7135a05dc1> in <module>
    ----> 1 interp = NBeatsInterpretation.from_learner(learn)
    

    NameError: name 'NBeatsInterpretation' is not defined
...
```
    ...
    <ipython-input-16-a74a0566c382> in <module>
    ----> 1 interp.plot_top_losses(3)
