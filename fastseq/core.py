...
__all__ = ['TSeries', 'no_emp_dim', 'show_graph', 'test_graph_exists', 'show_graphs', 'TensorSeq', 'skip',
...
# Cell
def skip(x,percentage_keep = .9):
    if (np.random.rand() > percentage_keep and x != 0):
        return False
    return True
